...
String? _localizedPlaybackErrorFromRaw(
  ...
  if (errorType == 'seek_not_supported') return raw;
...
class _QueueBottomSheet extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final hasUpcoming = currentDisplayIndex < queue.length - 1;
                        ...
                        IconButton(
                          ...
                          onPressed: queueIndex > state.currentIndex + 1
                              ? () {
                                  ref
                                      .read(playbackProvider.notifier)
                                      .reorderQueue(queueIndex, queueIndex - 1);
                                }
                              : null,
                          visualDensity: VisualDensity.compact,
                        ),
                        IconButton(
                          ...
                          onPressed: queueIndex < state.queue.length - 1
                              ? () {
                                  ref
                                      .read(playbackProvider.notifier)
                                      .reorderQueue(queueIndex, queueIndex + 2);
                                }
                              : null,
                          visualDensity: VisualDensity.compact,
                        ),
